...
#define DDRv(DATA) DDRB = (DDRB & 0xE5) | ( ((DATA & (1<<7)) >> 3) | ((DATA & (1<<6)) >> 3) | ((DATA & (1<<5)) >> 5) ); DDRD = (DDRD & 0x43) | ( ((DATA & (1<<4)) << 3) ); DDRD &= ~( ((DATA & (1<< 3)) << 0) | ((DATA & (1<<2)) << 3) | ((DATA & (1<<1)) << 3) | ((DATA & (1<<0)) << 2) );
#define PORTv(DATA) PORTB = (PORTB & 0xE5) | ( ((DATA & (1<< 7)) >> 3) | ((DATA & (1<<6)) >> 3) | ((DATA & (1<<5)) >> 5)); PORTD |=((DATA & (1<<4))<< 3)| ( ((DATA & (1<< 3)) << 0) | ((DATA & (1<<2)) << 3) | ((DATA & (1<<1)) << 3) | ((DATA & (1<<0))<< 2) );
